CLASS /dmo/cx_flight_legacy16 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_16',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_16',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id16 OPTIONAL
        booking_id            TYPE /dmo/booking_id16 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id16 OPTIONAL
        agency_id             TYPE /dmo/agency_id16 OPTIONAL
        customer_id           TYPE /dmo/customer_id16 OPTIONAL
        carrier_id            TYPE /dmo/carrier16-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_16-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_16-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date16 OPTIONAL
        end_date              TYPE /dmo/end_date16 OPTIONAL
        booking_date          TYPE /dmo/booking_date16 OPTIONAL
        flight_date           TYPE /dmo/flight_date16 OPTIONAL
        status                TYPE /dmo/travel_status16 OPTIONAL
        currency_code         TYPE /dmo/currency_code16 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id16,
          mv_booking_id            TYPE /dmo/booking_id16,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id16,
          mv_agency_id             TYPE /dmo/agency_id16,
          mv_customer_id           TYPE /dmo/customer_id16,
          mv_carrier_id            TYPE /dmo/carrier16-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_16-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_16-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date16,
          mv_end_date              TYPE /dmo/end_date16,
          mv_booking_date          TYPE /dmo/booking_date16,
          mv_flight_date           TYPE /dmo/flight_date16,
          mv_status                TYPE /dmo/travel_status16,
          mv_currency_code         TYPE /dmo/currency_code16,
...
CLASS /dmo/cx_flight_legacy16 IMPLEMENTATION.

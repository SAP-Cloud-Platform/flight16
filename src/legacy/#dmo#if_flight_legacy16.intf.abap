...
INTERFACE /dmo/if_flight_legacy16
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL16
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel16     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING16
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking16    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_16
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_16 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT16
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight16 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id16.
  ...
  TYPES booking_id TYPE /dmo/booking_id16.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id16.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL16, /DMO/BOOKING16, /DMO/BOOK_SUP_16 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code16.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code16,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status16,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel16_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id16.
  INCLUDE TYPE /dmo/booking16_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id16.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id16.
  INCLUDE TYPE /dmo/book_sup_16_data.

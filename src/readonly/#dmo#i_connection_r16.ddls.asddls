@AbapCatalog.sqlViewName: '/DMO/ICONNE_R16'
...
define view /DMO/I_Connection_R16
  as select from /dmo/connecti_16 as Connection

  association [1..*] to /DMO/I_Flight_R16 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier16  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport16',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true

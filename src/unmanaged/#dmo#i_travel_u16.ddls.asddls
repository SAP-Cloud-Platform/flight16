@AbapCatalog.sqlViewName: '/DMO/ITRAV_U16'
...
define root view /DMO/I_Travel_U16
  as select from /dmo/travel16 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U16 as _Booking

  association [0..1] to /DMO/I_Agency16       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer16     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency16', element: 'AgencyID'  } }]

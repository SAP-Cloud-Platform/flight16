@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U16'
...
define view /DMO/I_BookingSupplement_U16
  as select from /dmo/book_sup_16 as BookingSupplement

  association        to parent /DMO/I_Booking_U16  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement16     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement16Text16 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT16', element: 'SupplementID' },
